...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getDb\": () => (/* binding */ getDb),\n/* harmony export */   \"putDb\": () => (/* binding */ putDb)\n/* harmony export */ });\n/* harmony import */ var idb__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! idb */ \"./node_modules/idb/build/esm/index.js\");\n // import 'regnerator-runtime/runtime';\n\nconst initdb = async () => (0,idb__WEBPACK_IMPORTED_MODULE_0__.openDB)('jate', 1, {\n  upgrade(db) {\n    if (db.objectStoreNames.contains('jate')) {\n      console.log('jate database already exists');\n      return;\n    }\n\n    db.createObjectStore('jate', {\n      keyPath: 'id',\n      autoIncrement: true\n    });\n    console.log('jate database created');\n  }\n\n}); // TODO: Add logic to a method that accepts some content and adds it to the database - Done\n\n\nconst putDb = async content => {\n  console.log('PUT to the database.'); // Connect to database and version\n\n  const jateDb = await (0,idb__WEBPACK_IMPORTED_MODULE_0__.openDB)('jate', 1); // New transaction specifying store and data privileges\n\n  const tx = jateDb.transaction('content', 'readwrite'); // Open object store\n\n  const store = tx.objectStore('content'); // Update content. \n\n  const request = store.put({\n    content: content\n  }); // Confirmation of request\n\n  const result = await request;\n  console.log('Data saved to database.', result);\n}; // TODO: Add logic for a method that gets all the content from the database - Done\n\nconst getDb = async () => {\n  console.log('GET data from database.'); // Connect to IndexedDB databse and the version to use\n\n  const jateDb = await (0,idb__WEBPACK_IMPORTED_MODULE_0__.openDB)('jate', 1); // New transaction specifying the store and data privileges\n\n  const tx = jateDb.transaction('content', 'readonly'); // Open object store\n\n  const store = tx.objectStore('content'); // Get all data in the database\n\n  const request = store.getAll(); // Confirmation of request\n\n  const result = await request;\n  console.log('result.value', result);\n  return result;\n};\ninitdb();\n\n//# sourceURL=webpack://JATE/./src/js/database.js?");
